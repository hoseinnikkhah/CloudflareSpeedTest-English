...
func endPrint() {
	...
	if runtime.GOOS == "windows" { // If it is a Windows system, you need to press the Enter key or Ctrl+C to exit (to avoid double-clicking to run, close it directly after the speed measurement is completed）
